...
label_title = tk.Label(frame1, text="FACE DETECTION AND CROWD COUNTING")
label_font = font.Font(size=20, weight='bold',family='Helvetica')
label_title['font'] = label_font
label_title.grid(pady=(10,10), column=2)


icon = Image.open('icons/fd.png')
...
btn4 = tk.Button(frame1, text='YOLO', height=90, width=200, fg='green', command=record, image=btn4_image, compound='left')
btn4['font'] = btn_font
btn4.grid(row=5, pady=(20,10), column=3)


btn6 = tk.Button(frame1, text='FACE COUNT', height=90, width=310, fg='green', command=in_out, image=btn6_image, compound='left')
btn6['font'] = btn_font
...
btn7 = tk.Button(frame1, text="FACE DETECT", fg="green",command=maincall, compound='left', image=btn7_image, height=90, width=310)
btn7['font'] = btn_font
